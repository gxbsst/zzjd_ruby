...
$mqtt_duiduo.subscribe(
    'workstations/1/duiduo/2001/6497', # 物流方向--01入库--02出库--03取空货箱
    'workstations/1/duiduo/2001/6498', # 入/出库位置
    'workstations/1/duiduo/2001/6499', # 料台位置--01南料台--02北侧料台
    'workstations/1/duiduo/2001/6503', # 清理入库、出库、取空箱完成标志位
    'workstations/1/duiduo/2001/6501', # 物流状态----00堆垛车网络掉线--01正常（空闲）--02忙--03空闲报警--04运行报警
    'workstations/1/duiduo/2001/6502', # 传送链叫料---01需要上料（出库）
    'workstations/1/duiduo/2001/6503', # 入库/出库工作完成状态--01入库完成--02出库完成--03取空箱完成
    'workstations/1/duiduo/2001/6504', # 入/出库位置--入库/出库/取空箱位置
    'workstations/1/duiduo/2001/6505', # 料台位置
)
